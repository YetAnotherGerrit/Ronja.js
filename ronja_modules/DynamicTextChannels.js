    ...
    createTextChannel: async function(game, newActivity, newPresence) {
        if (this.cfg.dtcGamesCategory) {
            ...
            this.notifyChannel(
                ...
                this.l(newPresence.guild.preferredLocale,"Some of you guys played a new game recently. To provide you with a channel to talk about it, #%s has been created.\n\nOthers will be added to that channel once I see them playing the same game.", newChannel.name)
            );
        } else {
                ...
                if (gameChannel.parentId == this.cfg.dtcArchivedGamesCategory) {
                    if (await this.countPlayersForGame(game, this.cfg.daysTarget) > 1) {
                        ...
                        this.notifyChannel(
                            ...
                            this.l(newPresence.guild.preferredLocale,"Some of you guys re-discovered %s recently. #%s has been re-activated from the archive.\n\nOthers will be added to that channel once I see them playing it.", game.name, gameChannel.name)
                        );    
                    }
                } else {
